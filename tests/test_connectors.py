...
from cert_issuer.connectors import broadcast_tx, get_unspent_outputs, BitcoindConnector, get_balance
...
class TestConnectors(unittest.TestCase):
    ...
    @patch.object(bitcoin.rpc.Proxy, 'listunspent', fake_list_unspent)
