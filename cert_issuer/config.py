...
def add_arguments(p):
    ...
    p.add('-r', '--revoke', action='store_true', help='revoke certificates in file set in revocation_list_file')
    ...
    p.add_argument('--revocation_list_file', required=False, help='list of certificates or batches to be revokes', env_var='REVOCATION_LIST_FILE')
